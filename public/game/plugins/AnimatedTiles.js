(function webpackUniversalModuleDefinition (root, factory) {
  if (typeof exports === 'object' && typeof module === 'object') { module.exports = factory() } else if (typeof define === 'function' && define.amd) { define([], factory) } else if (typeof exports === 'object') { exports.AnimatedTiles = factory() } else { root.AnimatedTiles = factory() }
})(window, function () {
 ...
 */
      ...
      const AnimatedTiles = (function (_Phaser$Plugins$Scene) {
    ...
    */
        function AnimatedTiles (scene, pluginManager) {
          ...
          const _this = _possibleConstructorReturn(this, (AnimatedTiles.__proto__ || Object.getPrototypeOf(AnimatedTiles)).call(this, scene, pluginManager))
        ...
        _createClass(AnimatedTiles, [{
          ...
          value: function setRate (rate) {
            const gid = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null
            const map = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null
            ...
            if (gid === null) {
              ...
              const loopThrough = function loopThrough (animatedTiles) {
          ...
          value: function resetRates () {
            const mapIndex = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null
          ...
          value: function resume () {
            ...
            const layerIndex = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null
            const mapIndex = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null
          ...
          value: function updateLayer (animatedTile, layer) {
            const oldTileId = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : -1
            ...
            container.forEach(function (mapAnimData) {
              ...
              mapAnimData.animatedTiles.forEach(function (tileAnimData) {
                tileAnimData.tiles.forEach(function (tiles, layerIndex) {
                  ...
                  for (let _x9 = chkX; _x9 < chkX + chkW; _x9++) {
                    for (let _y = chkY; _y < chkY + chkH; _y++) {
                      const tile = mapAnimData.map.layers[layerIndex].data[_x9][_y]
